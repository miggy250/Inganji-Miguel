        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-3 items-center justify-center text-xl md:text-2xl text-muted-foreground">
              ...
              <span className="text-accent font-semibold">Volleyball Player</span>
            </div>
          </div>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Crafting elegant code and powerful spikes. Building digital solutions by day, 
            dominating the court by evening. Passion-driven in both worlds.
          </p>
